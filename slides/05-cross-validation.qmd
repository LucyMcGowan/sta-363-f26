...
## Application exercise 5, part 1 {.small}

**1.** Go to [Google Colab](https://colab.research.google.com)

**2.** Notice that we are not splitting. Cross-validation will do the
splitting for us. Run the cell above, then compute:
...
3. Compute the mean and the standard deviation. What does the standard
deviation tell you that the mean does not?
:::
...
## Application exercise 5, part 2

::: {.question}
Which $K$ does cross-validation choose? Is it the same one your single split chose on Friday?
:::
...
## Application exercise 5, part 3 {.small}
...
::: {.question}
Go back to Friday's exercise and do the same thing with nine single
splits. Which procedure is more stable?
:::
...
## Application exercise 5, part 4 {.small}
...
::: {.question}
If the difference between them is smaller than the fold-to-fold
variability, which would you actually ship? Why?
:::
...
## Application exercise 5, part 5 {.small}

::: {.question}
In Part 1 you put `StandardScaler` inside `make_pipeline` rather than
scaling `X` beforehand. Suppose you had instead written
