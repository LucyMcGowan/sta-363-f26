...
::: {.fragment}
::: {.question}
Would a straight line be a good description of this relationship? What
shape do you see?
:::
:::
...
At which `df` do the two columns start to disagree about the direction of
improvement? What is happening there?
:::
:::
...
::: {.fragment}
::: {.question}
Compare this to Figure 2.9 in the textbook. Which of the three panels
(Figures 2.9, 2.10, 2.11) does the `Auto` data most resemble? What does
that tell you about the true $f$?
:::
:::
...
::: {.fragment}
::: {.question}
How much did your answer move? If a colleague reported "the best model has
20 degrees of freedom" based on one split, how much would you trust them?
:::
:::
